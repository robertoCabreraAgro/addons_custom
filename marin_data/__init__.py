...
def _post_init_marin(env):
    ...
    records = [
        ...
        (
            lmmr,
            "Bank BBVA revolving business credit",
            False,
            "202.03.003",
        ...
        (
            lmmr,
            "Discounts on purchases from payment in LMMG",
            False,
            "503.01.007",
            "income_other",
        ),
        ...
        (
            lmmg,
            "Discounts on purchases from payment in LMMR",
            False,
            "503.01.006",
            "income_other",
        ),
    ...
    for r in records:
        ...
        if not exist:
            code_store = (
                ...
                or r.with_company(lmmg).code_store
                or r.with_company(tjgl).code_store
                or r.with_company(xm).code_store
            )
    ...
    tools.convert.convert_file(
        env,
        "marin_data",
        "data/account.journal.group.csv",
        None,
        mode="init",
        noupdate=True,
    )
    ...
    tools.convert.convert_file(
        env,
        "marin_data",
        "data/account.tax.repartition.line.csv",
        None,
        mode="init",
        noupdate=True,
    )
    ...
    tools.convert.convert_file(
        env,
        "marin_data",
        "data/hr_payroll_structure_nomina_data.xml",
        None,
        mode="init",
        noupdate=True,
    )
    tools.convert.convert_file(
        env,
        "marin_data",
        "data/hr_payroll_structure_nomina_christmas_bonus_data.xml",
        None,
        mode="init",
        noupdate=True,
    )
    tools.convert.convert_file(
        env,
        "marin_data",
        "data/hr_payroll_structure_nomina_finiquito_data.xml",
        None,
        mode="init",
        noupdate=True,
    )
    tools.convert.convert_file(
        env,
        "marin_data",
        "data/hr_payroll_structure_misc_data.xml",
        None,
        mode="init",
        noupdate=True,
    )
    ...
    tools.convert.convert_file(
        env,
        "marin_data",
        "data/account.analytic.distribution.model.csv",
        None,
        mode="init",
        noupdate=True,
    )
