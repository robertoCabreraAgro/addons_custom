...
class DbBackupConfigure(models.Model):
    ...
    def _compute_redirect_uri(self):
        ...
        for rec in self:
            ...
            rec.gdrive_redirect_uri = (
                self.get_base_url() + "/google_drive/authentication"
            )
    ...
    def action_get_onedrive_auth_code(self):
        ...
        action_id = (
            ...
            .sudo()
            ._for_xml_id("auto_database_backup.db_backup_configure_action")["id"]
        )
            ...
            # FTP backup
                ...
                try:
                    ...
                    with open(temp.name, "wb+") as tmp:
                        self.dump_data(
                            rec.db_name, tmp, rec.backup_format, rec.backup_frequency
                        )
    ...
    def dump_data(self, db_name, stream, backup_format, backup_frequency):
        ...
        cron_user_id = self.env.ref(
            f"auto_database_backup.ir_cron_auto_db_backup_{backup_frequency}"
        ).user_id.id
