...
class TestSale(TestSaleCommon):
    ...
    def test_01_sale_order_computed_values(self):
        ...
        self.assertTrue(order.line_ids.product_updatable)
        ...
        self.assertFalse(order.line_ids.product_updatable)
    ...
    def test_02_sale_order_authorize_debt(self):
        ...
        order.line_ids.price_unit = 10.0
        order._compute_partner_credit_warning()
    ...
    def test_06_sale_line_ids_order_view(self):
        sale_line = self.sale_order.line_ids
    ...
    def test_08_sale_order_price_history(self):
        ...
        order.action_confirm()
        order2.line_ids.price_unit = 7.50
        order2.action_confirm()
        order3.line_ids.price_unit = 10.00
        with Form(self.env["sale.order.line.price.history"]) as form_wiz:
            form_wiz.product_id = order.line_ids.product_id
