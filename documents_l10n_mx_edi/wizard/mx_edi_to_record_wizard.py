...
class MxEdiToRecordWizard(models.TransientModel):
    ...
    #     domain=lambda self: "[('company_ids', 'in', %s)]" % (self.company_id | self.env.company).ids,
    #     help="This account will be used in the vendor bills generated by this document. "
    #          "If this account is not set, will be used the default account.",
    # )
