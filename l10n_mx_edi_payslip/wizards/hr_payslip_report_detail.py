...
class HrPayslipReportDetail(models.TransientModel):
    ...
    date_from = fields.Date(
        ...
        help="The report will be generated with payslips after of this date",
    )
    date_to = fields.Date(
        required=True,
        default=time.strftime("%Y-12-31"),
        help="The report will be generated with payslips before of this date",
    )
