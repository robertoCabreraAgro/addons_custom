...
class TestABCClassificationProfile(TransactionCase):
    ...
    def _confirm_sale_order(cls, products, qty, partner=None):
        ...
        sale = sale_order.create(so_values)
        sale.action_confirm()
        return sale

    @classmethod
    def _confirm_ship(cls, sale_order):
        pick = sale_order.mapped("picking_ids")
        pick.action_confirm()
        pick.action_assign()
    ...
    def _assert_leve_is(self, product, level_name):
    ...
    def test_00(self):
        ...
        self._assert_leve_is(self.product1, "a")
        self._assert_leve_is(self.product3, "a")
        self._assert_leve_is(self.product5, "b")
        self._assert_leve_is(self.product6, "b")
        self._assert_leve_is(self.product2, "c")
        self._assert_leve_is(self.product4, "c")
        self._assert_leve_is(self.product_new, "c")
