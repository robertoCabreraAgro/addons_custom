...
class TestsCommon(common.TransactionCase):
    ...
    def setUpClass(cls):
        ...
        cls.wizard_obj = cls.env["stock.quant.relocate"]
    ...
    def _create_wizard(
        ...
        move_location_wizard = self.env["stock.quant.relocate"]
        return move_location_wizard.create(
            {
                "location_origin_id": origin_location.id,
                "location_destination_id": destination_location.id,
