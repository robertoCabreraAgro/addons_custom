...
class ResPartner(models.Model):
    ...
    def _compute_l10n_mx_edi_fiscal_regime(self):
        ...
        for partner in self:
            if partner.country_code == 'MX' and partner.l10n_mx_edi_fiscal_regime_id:
                partner.l10n_mx_edi_fiscal_regime = partner.l10n_mx_edi_fiscal_regime_id.code
        return res
    ...
    def _check_l10n_mx_edi_fiscal_regime_id(self):
        ...
        for partner in self:
            if partner.l10n_mx_edi_fiscal_regime_id and partner.l10n_mx_edi_fiscal_regime_ids:
                if partner.l10n_mx_edi_fiscal_regime_id not in partner.l10n_mx_edi_fiscal_regime_ids:
    ...
    def _onchange_l10n_mx_edi_fiscal_regime_ids(self):
        ...
        if self.l10n_mx_edi_fiscal_regime_id and self.l10n_mx_edi_fiscal_regime_ids:
            if self.l10n_mx_edi_fiscal_regime_id not in self.l10n_mx_edi_fiscal_regime_ids:
